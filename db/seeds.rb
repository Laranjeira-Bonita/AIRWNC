...
bk1 = Booking.new(date: '2020/11/28 19:30:00', duration: 45)
bk1.bathroom = b1
bk1.client = u4
bk1.save!

bk2 = Booking.new(date: '2020/10/12 9:00:00', duration: 15)
bk2.bathroom = b1
bk2.client = u3
bk2.save!
rv1 = Review.new(rating: 4, content: 'Limpinho! Donos muito atenciosos, voltaria sempre')
rv1.booking = bk2
rv1.save!

bk3 = Booking.new(date: '2020/11/22 15:00:00', duration: 25)
bk3.bathroom = b5
bk3.client = u2
bk3.save!
